    ...
    <main>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-gray-600 mb-8 max-w-3xl">
          Clusters represent groups of actors who frequently work together. These networks can reveal interesting patterns in casting and collaboration across the entertainment industry.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {clusters.map(cluster => (
            <div key={cluster.id} className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="mb-4">
                <h3 className="text-sm font-medium text-gray-500 mb-2">Top Actors:</h3>
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-2">Common Productions:</h3>
                <div className="flex flex-wrap gap-2">
...
const mockClusters = [
  {
    ...
    description: 'Actors who frequently appear in Steven Spielberg films, known for their dramatic performances and versatility.',
    topActors: [
  ...
  },
  {
    ...
    description: 'The core group of actors who appear across multiple Marvel superhero films and form the backbone of the MCU.',
    topActors: [
  ...
  },
  {
    ...
    description: 'The quirky and distinctive group of actors who regularly appear in Wes Anderson\'s stylized films.',
    topActors: [
  ...
  },
  {
    ...
    description: 'Actors who have appeared in multiple acclaimed HBO drama series, known for their complex character portrayals.',
    topActors: [
  ...
  },
  {
    ...
    description: 'The distinctive group of actors who frequently appear in Quentin Tarantino\'s stylized and dialogue-heavy films.',
    topActors: [
      { id: '51329', name: 'Samuel L. Jackson' },
  ...
  },
  {
    ...
    description: 'Actors who frequently collaborate with the Coen Brothers, known for their distinctive performances in quirky and often dark comedies.',
    topActors: [
