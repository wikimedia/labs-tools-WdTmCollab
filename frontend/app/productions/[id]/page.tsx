    ...
    <main>      
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          ...
          <div className="border-t">
            <div className="p-8">
              <h2 className="text-xl font-semibold mb-4">Find Actors in Common</h2>
              
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="mb-4">Select another production to find actors who appeared in both:</p>
...
const mockProductions = [
  ...
  { 
    ...
    year: 2017, 
    type: 'Movie',
    description: 'A cover-up spanning four U.S. Presidents pushes the country\'s first female newspaper publisher and her editor to join an unprecedented battle between press and government.',
    actors: [
